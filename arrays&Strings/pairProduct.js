// Link to problem: https://structy.net/problems/premium/pair-product

// Approach:
// We are trying to find two numbers that multiply to the target. So, we can iterate through the 
// array of numbers and divide the current number from the target to find its complement. Then,
...
// no pairs that multiply to the target), we'll end up storing all the numbers as keys in our object.